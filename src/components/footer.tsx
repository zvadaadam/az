...
function Footer() {
  return (
    <div className="fixed bottom-0 z-50 w-full px-6 pb-6 bg-black">
      <div className="flex items-center justify-between border-t border-gray-800 pt-3">
        ...
        <div className="flex justify-end gap-2 items-center">
          <a href="https://adamzvada.substack.com/" target="_blank" rel="noopener noreferrer" className="p-2 text-gray-500 hover:text-white transition-all">
