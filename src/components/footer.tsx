    ...
    <div className="fixed bottom-0 z-50 w-full px-6 bg-black">
      <div className="flex items-center justify-between border-t border-zinc-800 py-3">
        <div className="text-sm text-white">
          ...
          <span className="hidden md:inline text-zinc-500"> — hello@adamzvada.com</span>
        </div>
        <div className="flex justify-end gap-2 items-center">
          <a href="https://adamzvada.substack.com/" target="_blank" rel="noopener noreferrer" className=" text-zinc-500 hover:text-white transition-all">
